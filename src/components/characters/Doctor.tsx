  ...
  return (
    <group ref={groupRef} {...props}>
      ...
      <mesh position={[0, 1.8, -0.05]}>
        ...
        <meshStandardMaterial color="#4A4A4A" roughness={0.9} metalness={0.0} />
      </mesh>
      
      {/* Body/Torso */}
      <mesh position={[0, 1.3, 0]}>
        <cylinderGeometry args={[0.15, 0.15, 0.4, 16]} />
        <meshStandardMaterial color="#2E8B57" roughness={0.7} metalness={0.0} />
      </mesh>
      
      {/* Scrub top collar */}
      <mesh position={[0, 1.5, 0.05]}>
        <boxGeometry args={[0.25, 0.08, 0.02]} />
        <meshStandardMaterial color="#228B22" roughness={0.6} metalness={0.0} />
      </mesh>
      
      {/* Pocket */}
      <mesh position={[-0.1, 1.3, 0.08]}>
        <boxGeometry args={[0.08, 0.06, 0.01]} />
        <meshStandardMaterial color="#228B22" roughness={0.8} metalness={0.0} />
      </mesh>
      ...
      <mesh position={[0, 1.05, 0]}>
        ...
        <meshStandardMaterial color="#228B22" roughness={0.4} metalness={0.1} />
      </mesh>
