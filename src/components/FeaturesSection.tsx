...
const FeaturesSection = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Live Map of Doctor Requests to Keep the Flow. When a room requests a doctor, it lights up on the floor plan and jumps in the doctor queue—so leads can route the doctor instantly and keep both op and hygiene schedules on time.",
      align: "right"
    }
  ];
